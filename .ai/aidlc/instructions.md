...
**CRITICAL**: When performing any phase, you MUST read and use relevant content from rule detail files in `.ai/aidlc/rules/` directory.

This directory is used consistently across all platforms (Cline, Kiro CLI, Amazon Q, Cursor, GitHub Copilot).
...
1. Load the welcome message from `.ai/aidlc/rules/common/welcome-message.md`
